...
<section id="codeList">
	...
	<div class="row">
	    ...
	    <div class="col-lg-8">
	        <button id="cmdAddCode" type="submit" class="btn btn-primary pull-right btn-form-custom btn-form-custom-2" onclick="cmdCodeAdd_OnClick()">Add</button>
	    </div>
	</div>
	<br />
            ...
            <div class="modal-body">
                <form id="messageForm" class="modal-form-custom">
                    <dl class="dl-horizontal">
                        <dt>Code</dt>
                        <dd>
                            <input class="form-control modal-custom-input" id="EDIT_CODE_ID" type="hidden" />
                            <input class="form-control modal-custom-input" id="EDIT_CODE_KIND_CODE" name="EDIT_CODE_KIND_CODE" type="text" required />
                        </dd>
                        <dt>Code Value</dt>
                        <dd>
                            <input class="form-control modal-custom-input" id="EDIT_CODE_CODE_VALUE" name="EDIT_CODE_CODE_VALUE" type="text" required />
                        </dd>
                        <dt>Note</dt>
                        <dd>
							<input class="form-control modal-custom-input" id="EDIT_CODE_NOTE" name="EDIT_CODE_NOTE" type="text" required /> 
                        </dd>
                        <dt>Text</dt>
                        <dd>
							<input class="form-control modal-custom-input" id="EDIT_CODE_TEXT" name="EDIT_CODE_TEXT" type="text" required /> 
                        </dd>                        
                        <dt>Is displayed?</dt>
                        <dd>
							<input class="form-control modal-custom-input" id="EDIT_CODE_ISDISPLAY" name="EDIT_CODE_ISDISPLAY" type="text" required /> 
                        </dd>                       
                    </dl>
                </form>
            </div>
            <div class="modal-footer modal-footer-custom">
                <button type="button" class="btn btn-primary btn-form-custom btn-form-custom-2"  id="cmdCodeEditOk" onclick="cmdCodeEditOk_OnClick()">
                    Ok
                </button>
                <button type="button" class="btn btn-danger btn-form-custom btn-form-custom-2" id="cmdCodeEditCancel" onclick="cmdCodeEditCancel_OnClick()">
                    Cancel
                </button>
            </div>
        </div>
