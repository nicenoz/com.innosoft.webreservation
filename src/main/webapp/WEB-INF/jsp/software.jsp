...
<section id="messageList">
	...
	<div class="row">
	    <div class="col-lg-3">
	        <dt>Start Date: </dt>
	        <dd>
		        <div id="EDIT_MESG_START_DATE" class="form-control software-button-style-custom"></div>
	    ...
	    <div class="col-lg-3">
	        <dt>End Date: </dt>
	        <dd>
		       	<div id="EDIT_MESG_END_DATE" class="form-control software-button-style-custom"></div>
               	<input class="form-control modal-custom-input" id="EDIT_MESG_END_DATE_DATA" type="hidden" required/>        
            </dd>
	    </div>
	    
	    <div class="col-lg-6 software-column-custom">
			<dt></dt>
	        <dd>
	        	<button id="cmdAddMessage" type="submit" class="btn btn-primary  software-button-style-custom" onclick="cmdMessageAdd_OnClick()">Add</button>
		        <button id="cmdAddMessage" type="submit" class="btn btn-primary  software-button-style-custom" onclick="cmdMessageAdd_OnClick()">Create Schedule</button>
            </dd>
	    </div>
	</div>
	<br />
