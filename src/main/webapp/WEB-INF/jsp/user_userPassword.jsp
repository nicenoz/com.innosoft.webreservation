					...
					<div class="col-md-4 col-md-offset-4">
						<div class="login-panel panel panel-body-border">
							...
							<div class="panel-body">
								<fieldset>
									<input type="password" name=""
										class="form-control border-custom" id="OLD_PASSWORD" size="30"
										maxlength="40" placeholder="Current Password" />
									<hr />
									<input type="password" name=""
										class="form-control border-custom" id="USER_PASSWORD"
										size="30" maxlength="32" placeholder="New Password" /> <br />
									<input type="password" name=""
										class="form-control border-custom"
										id="CONFIRMED_USER_PASSWORD" size="30" maxlength="32"
							...
							<span class="footer-data-style" id="name"> <sec:authorize
									...
									<input id="USER_LOGIN" type="hidden"
...
<script type="text/javascript">
	function ChangePassword_Onclick() {
		if (document.getElementById("OLD_PASSWORD").value != document
				.getElementById("USER_PASSWORD").value
				&& document.getElementById("USER_PASSWORD").value == document
						.getElementById("CONFIRMED_USER_PASSWORD").value) {
			var userObject = new Object();

			userObject.USER_LOGIN = document.getElementById('USER_LOGIN').value;
			userObject.USER_PASSWORD = document
					.getElementById('CONFIRMED_USER_PASSWORD').value;
