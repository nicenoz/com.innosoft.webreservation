...
<body class="bodytopindent">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li><a href="/webreservation/software/email/">Send
									Magazine Email</a></li>
							<li><a href="/webreservation/software/notificationEmail/">Send
									Notification Email</a></li>
						</ul></li>

					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">User <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="/webreservation/user/"><b>User
										Dashboard</b></a></li>
							<li class="divider"></li>
							<li><a href="/webreservation/user/user/">User
									Information</a></li>
							<li><a href="/webreservation/user/userPassword">Change
									Password</a></li>
							<li class="divider"></li>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="/webreservation/system/activity/">Calendar
									Activity</a></li>
							<li class="divider"></li>
							...
							<li class="divider"></li>
							<li><a href="/webreservation/system/userPassword/">Change
									Password</a></li>
						</ul></li>
	...
	<script type="text/javascript">
		function onClick_Logout() {
			alertify.confirm("" + getMessage("P0003"), function(e) {
				if (e) {
