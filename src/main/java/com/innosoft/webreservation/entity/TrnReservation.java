...
public class TrnReservation {
	...
	public MstCustomerMember RESV_MEBR;
	
	@ManyToOne
	@JoinColumn(name="RESV_CACT_ID", insertable=false, updatable=false)
	public MstCalendarActivity RESV_CACT;	
	...
	public MstCustomerMember getRESV_MEBR() {
		return RESV_MEBR;
	}
	public void setRESV_MEBR(MstCustomerMember rESV_MEBR) {
		RESV_MEBR = rESV_MEBR;
	}	
	public MstCalendarActivity getRESV_CACT() {
		return RESV_CACT;
	}
	public void setRESV_CACT(MstCalendarActivity rESV_CACT) {
		RESV_CACT = rESV_CACT;
	}	
}
