...
/****************************/
/* WR_SYSTEM_SETTINGS Table */
/****************************/
DROP TABLE WR_SYSTEM_SETTINGS;		
CREATE TABLE WR_SYSTEM_SETTINGS (  
  SSET_ID int NOT NULL,   
  SSET_NOTIFICATION_TIME varchar(255) NOT NULL,
  SSET_NOTIFICATION_DATE Date NOT NULL,
  SSET_NOTIFICATION_NO_OF_DAYS int,
  CONSTRAINT WR_SYSTEM_SETTINGS_PK PRIMARY KEY (SSET_ID)
);
